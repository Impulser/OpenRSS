...
using RSUtilities.Compression.BZip2;
...
namespace RSUtilities.Compression.BZip2
{
    ...
    public class CBZip2InputStream : InputStream, BZip2Constants
    {
        ...
        private sealed class Data : object
        {
            ...
            internal readonly int[][] @base = ArrayUtil.ReturnRectangularArray<int>(BZip2Constants_Fields.N_GROUPS, BZip2Constants_Fields.MAX_ALPHA_SIZE); //     6192 byte
            ...
            internal readonly int[][] limit = ArrayUtil.ReturnRectangularArray<int>(BZip2Constants_Fields.N_GROUPS, BZip2Constants_Fields.MAX_ALPHA_SIZE); //     6192 byte

            internal readonly int[] minLens = new int[BZip2Constants_Fields.N_GROUPS]; //       24 byte

            internal readonly int[][] perm = ArrayUtil.ReturnRectangularArray<int>(BZip2Constants_Fields.N_GROUPS, BZip2Constants_Fields.MAX_ALPHA_SIZE); //     6192 byte
            ...
            internal readonly char[][] temp_charArray2d = ArrayUtil.ReturnRectangularArray<char>(BZip2Constants_Fields.N_GROUPS, BZip2Constants_Fields.MAX_ALPHA_SIZE); //     3096 byte
